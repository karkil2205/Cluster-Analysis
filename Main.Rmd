...
* $\mathbf{x}$ is observed for indiviual 1.
* $\mathbf{y}$ is observed for indiviual 2. 
* We can then calate the following statistics:
   $$a=\mathbf{x\cdot y}=\sum_{i=1}^nx_iy_.$$
   $$b=\mathbf{x\cdot (1-y)}=\sum_{i=1}^nx_iy_.$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjYyNDQ2NTAsLTIzOTY1OTIxMywtMT
c1NjQ3MTEzMSwtMTk3NDU4OTM2OCwxMTY3NjAzODU4LDU1MTE1
NDM5OCwtMTgwNTI5NzQ3MSwtMTQ0NTYzMzAyNSwtMTk1MDkyMj
IyOCw3MTI2Njc2OCw4Njk3NTg2MjgsLTYxNjgzMDgwNSwxNDY3
NDU4NDU1LDE2MjMwNjE5MDgsLTkzNzE4Nzk2MywtMzA4MDMxMj
M1LDU0MDA0NjQzOSwtMTM3MjQyMzgwMyw4NTE5ODMwMjIsLTE4
NTgwNzk3ODFdfQ==
-->