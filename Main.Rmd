...
$$
* Note that the cosine of the angle between the two centred vectors $\mathbf{x}(x_1-\bar{\mathbf{x}},\cdots,x_n-\bar{\mathbf{x}})$ and $(y_1-\bar{\mathbf{y}},\cdots,y_n-\bar{\mathbf{y}})$ coincides with the Pearson correlation coefficient of $\mathbf{x}$ and $\mathbf{y}$.  
Where $\mathbf{1}$ is a vector of units of $\mathbb{R}^n$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc2MTE2MjExNCw0OTMwNTM0NzUsLTE1Mj
E0OTIxMTksNzAzNDE5NjI1LC0xNTIxNDkyMTE5LC0xNTIxNDky
MTE5LDE2ODUzOTk5MV19
-->