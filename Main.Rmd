...
* We assume there are $n$ measured characters.
* The presence is denoted by + and absence by -. 
* This gives the familiar 2 X 2 association table shown in 
* The entries are the counts of matches (i.e. (+,+) and (-,-)) and mismatches (i.e. (+,-) and (-,+)) in the $n$ characters for two individuals.
...
<thead>
  <tr>
    <th class="tg-0lax"></th>
    <th class="tg-c3ow" colspan="3">Individual 1</th>
    <th class="tg-0pky"></th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-j0tj" rowspan="3">Individual 2</td>
    <td class="tg-phtq"></td>
    <td class="tg-phtq">+</td>
    <td class="tg-phtq">-</td>
    <td class="tg-phtq">Totals</td>
  </tr>
  <tr>
    <td class="tg-0pky">+</td>
  ...
  <tr>
    <td class="tg-phtq">-</td>
    <td class="tg-phtq">c</td>
    <td class="tg-phtq">d</td>
    <td class="tg-phtq">c+d</td>
  </tr>
  <tr>
    <td class="tg-0lax"></td>
    <td class="tg-0lax">Totals</td>
    <td class="tg-0lax">a+c</td>
    <td class="tg-0lax">b+d</td>
    <td class="tg-0lax">n=a+b+c+d</td>
  </tr>
</tbody>
</table>
...
* The reason for such a large number of possible measures has to do with the apparent uncertainty as to how to deal with the count of zero–zero matches (d in Table 3.2).
...
* But in other cases the inclusion or otherwise of d is more problematic; for example, when the zero category corresponds to the genuine absence of some property, such as wings in a study of insects. The question that then needs to be asked is do the co-absences contain
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxMTc2MTA2MywtMTgwNTI5NzQ3MSwtMT
Q0NTYzMzAyNSwtMTk1MDkyMjIyOCw3MTI2Njc2OCw4Njk3NTg2
MjgsLTYxNjgzMDgwNSwxNDY3NDU4NDU1LDE2MjMwNjE5MDgsLT
kzNzE4Nzk2MywtMzA4MDMxMjM1LDU0MDA0NjQzOSwtMTM3MjQy
MzgwMyw4NTE5ODMwMjIsLTE4NTgwNzk3ODEsLTQ0MDAyMzk1LD
MzNzA3NDY1MywtMjU3MDU4NjY5LC0xNjMxNjIwNjMyLDQ0MjM3
NTY3NF19
-->