...
* This gives a $2 \times 2$ association table. 
* The entries are the counts of:
* matches , with $a$ for $(1,1)$ and $d$ for $(0,0)$;
* mismatches are for $b$ for $(1,0)$ and $c$ for $(0,1)$).
* Obviously, $a+b+c+d=n$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5NzY3OTQ3MywxMzM4NjE0MTc5LDQyMj
A0OTcyOCwtMTI2Mzg3Mjk2OCwtMTM1NDE5MDUwMiwtMjM5NjU5
MjEzLC0xNzU2NDcxMTMxLC0xOTc0NTg5MzY4LDExNjc2MDM4NT
gsNTUxMTU0Mzk4LC0xODA1Mjk3NDcxLC0xNDQ1NjMzMDI1LC0x
OTUwOTIyMjI4LDcxMjY2NzY4LDg2OTc1ODYyOCwtNjE2ODMwOD
A1LDE0Njc0NTg0NTUsMTYyMzA2MTkwOCwtOTM3MTg3OTYzLC0z
MDgwMzEyMzVdfQ==
-->